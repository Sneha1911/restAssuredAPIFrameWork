...
public class TC10_Post_Create_Emp_Record extends TestBase{
	...
	public void createEmp() throws InterruptedException {
		logger.info("*********** Start of TC10_Post_Create_Emp_Record ***************");
	...
	public void teardown() {
		logger.info("********** End of TC10_Post_Create_Emp_Record ************");
	}
}